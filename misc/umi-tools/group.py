...
import sam_methods as sam_methods
...
def main(argv):
    ...
    group.add_option("--use-introns", dest="use_introns", action="store_true",
                    default=False,
                    help=("set true if exon and intron assigned genes should be used"
                          "[default=%default]"))                       
